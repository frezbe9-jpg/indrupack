...
const fefcoStandards = [
  { code: "0201", title: "Стандартный", desc: "Клапаны встык.", icon: "M21 16V8L12 3L3 8V16L12 21L21 16ZM12 3V12M12 12L21 8M12 12L3 8" },
  { code: "0427", title: "Самосборный", desc: "Конструкция с ушками.", icon: "M3 8L12 13L21 8M3 16L12 21L21 16M12 13V21M12 13L21 8L12 3L3 8L12 13Z" },
  { code: "0203", title: "С перекрытием", desc: "Клапаны внахлест.", icon: "M12 21L21 16V8L12 13M12 21L3 16V8L12 13M12 13V3L21 8M12 3L3 8" },
  { code: "0300", title: "Телескоп", desc: "Крышка плюс дно.", icon: "M2 8L12 3L22 8L12 13L2 8ZM2 14L12 9L22 14L12 19L2 14Z" },
  { code: "0421", title: "С замком", desc: "Усиленные стенки.", icon: "M12 3L21 8V16L12 21L3 16V8L12 3ZM3 8L12 13M21 8L12 13" },
  { code: "0701", title: "Авто-дно", desc: "Быстрая сборка.", icon: "M12 2L3 7V17L12 22L21 17V7L12 2ZM12 12L3 7M12 12L21 7M12 12V22" }
];
